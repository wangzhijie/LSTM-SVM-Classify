...
sess = tf.Session()
# 
svm_train=pd.read_excel("svm_train.xlsx",header=None,index=False,sheet_name="Sheet1")
x_vals1=svm_train.iloc[0:500,:4]
x_vals2=svm_train.iloc[122880:123380,:4]
x_vals=np.array(pd.concat([x_vals1,x_vals2],ignore_index=True))
y_vals1=svm_train.iloc[0:500,4:5]
y_vals2=svm_train.iloc[122880:123380,4:5]
y_vals=np.array(pd.concat([y_vals1,y_vals2],ignore_index=True))
